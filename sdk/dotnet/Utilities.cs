...
namespace HummingbirdMe.Postmark
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/hummingbird-me/pulumi-postmark";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("HummingbirdMe.Postmark.version.txt");
    ...
    internal sealed class PostmarkResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PostmarkResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
